...
{
    public partial class edit_medecin : System.Web.UI.Page
    {
        int id;
        ...
        protected void updateButton_Click(object sender, EventArgs e)
        {
            ...
            if (photomedecin.FileName.ToString() != "")
            {
                ...
                cmd.CommandText = "UPDATE medecin SET firstname = '" + firstname.Text + "',lastname = '" + lastname.Text + "'," +
                    ...
                    "email = '" + email.Text + "',contact = '" + contact.Text + "',speciality = '"+specialites.Text+"',photo_medecin = '" + path.ToString() + "' Where Id = " + id + "";
                cmd.ExecuteNonQuery();
            }
            else if (photomedecin.FileName.ToString() == "")
            {
                ...
                cmd.CommandText = "UPDATE medecin SET firstname = '" + firstname.Text + "',lastname = '" + lastname.Text + "'," +
                    "username = '" + username.Text + "',password = '" + password.Text + "'," +
                    "email = '" + email.Text + "',contact = '" + contact.Text + "', speciality = '"+specialites.Text+"' Where Id = " + id + "";
                cmd.ExecuteNonQuery();
            }
