...
{
    public partial class login_medecin : System.Web.UI.Page
    {
        ...
        protected void loginButton_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "SELECT * From medecin where username = '" + username.Text + "' and password = '" + password.Text + "'";
            cmd.ExecuteNonQuery();
            ...
            if (userFound > 0)
            {
                ...
                {
                    Session["id_medecin"] = dr["Id"].ToString();
                }
                Session["medecin"] = username.Text;
